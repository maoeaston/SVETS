...
> **快照说明：** 本报告记录 M1 落地前以 schema v0.1.12 为输入的 v2.2 方案验证，不代表当前仓库实现状态。当前 schema 已为 v0.1.14，数据库迁移与三机开发同步见 `doc/features/multi-device-v2.2-migration-prd.md` 和 `doc/features/local-database-sync-sop.md`。
