// REPL driver for xc-career-guide Electron app.
// Run under xvfb on headless Linux. Designed for agents: wrap in tmux.
...
console.log('xc-career-guide driver — "help" for commands, "launch" to start');
rl.prompt();
